...
from lib_openmolar.client.qt4gui.dialogs.address_dialogs.find_address_dialog \
    import FindAddressDialog
from lib_openmolar.client.qt4gui.dialogs.address_dialogs.new_address_dialog \
    import NewAddressDialog
from lib_openmolar.client.qt4gui.dialogs.address_dialogs.known_address_new_link \
